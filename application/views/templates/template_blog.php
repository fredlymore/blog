...
<head>
        ...
        <title>Fredly Asmoro</title>
        <link rel="icon" type="image/x-icon" href="<?php echo base_url('./vendor/'); ?>assets/favicon.ico" />
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="<?php echo site_url(); ?>">FREDLY ASMORO</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link px-lg-3 py-3 py-lg-4" href="<?php echo site_url('blog/tambah'); ?>">Tambah Artikel</a>
                    </li>
                    <li class="nav-item">
